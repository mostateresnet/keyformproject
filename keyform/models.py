...
class Request(models.Model):
    ...
    amt_received = models.DecimalField(max_digits=7, decimal_places=2, default=0, blank=True, verbose_name= _('Amount received'), validators=[MinValueValidator(Decimal('0.00'))], help_text='Core Change/Reprogram Fob Charge = $50, Room Key/Fob = $10, Mailbox Key = $10, Monroe Mailbox Key = $25')
...
class KeyData(models.Model):
    ...
    core_number = models.CharField(max_length=35, verbose_name=_('New Core Number'), blank=True, help_text='Use a comma to separate the list of cores (if suite style).')
    ...
    quantity = models.IntegerField(validators=[MinValueValidator(0)], help_text="If you don't need to order more keys because there are enough already, you can mark zero.")
