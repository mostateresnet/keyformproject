...
class Request(models.Model):
    ...
    payment_method = models.CharField(max_length=2, choices=PAYMENT_TYPES, null=True, blank=True, help_text='')
...
class KeyData(models.Model):
    ...
    key_number = models.CharField(max_length=24, verbose_name=_('Lost/Stolen Key Number'), help_text='')
