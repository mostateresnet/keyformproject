...
class CreateForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['payment_method'] = TypedChoiceField(widget=RadioSelect(), choices=Request.PAYMENT_TYPES, help_text="Cash/Check should only be accepted during camps and conferences, and also fill in the amount received. Use the Charge Amount box to change to the student's account, or mark that the student was charged on the RCR if they are checking out.")
